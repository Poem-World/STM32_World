...
void HAL_HCD_MspInit(HCD_HandleTypeDef* hcdHandle)
{
  ...
  printf("[USB-MspInit] Initializing STM32H747I-DISCO ULPI hardware pins...\r\n");
  ...
  /* D1..D7 (PB0, PB1, PB5, PB10, PB11, PB12, PB13) */
  ...
  /* NXT (PH4) - STM32H747I-DISCO board physical pin */
  ...
  /* DIR (PI11) - STM32H747I-DISCO board physical pin */
  ...
  /* Enable USB OTG HS ULPI and Core Clocks */
  ...
  printf("[USB-MspInit] Hardware ULPI pins initialized successfully!\r\n");
  return; // Prevent CubeMX auto-generated default code below from running!
...
USBH_StatusTypeDef USBH_LL_Init(USBH_HandleTypeDef *phost)
{
  ...
  printf("[USB-LL] Calling HAL_HCD_Init...\r\n");
  HAL_StatusTypeDef hst = HAL_HCD_Init(&hhcd_USB_OTG_HS);
  printf("[USB-LL] HAL_HCD_Init result = %d\r\n", hst);
  if (hst != HAL_OK)
  {
    printf("[USB-LL] ERROR: HAL_HCD_Init failed!\r\n");
    Error_Handler( );
  }
